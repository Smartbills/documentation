---
title: Articles de Reçu | Documentation de l'API Smartbills
description: Apprenez à utiliser les fonctionnalités des articles de reçu de l'API Smartbills, y compris comment gérer les articles individuels sur les reçus, leurs descriptions, prix, et plus encore.
---
