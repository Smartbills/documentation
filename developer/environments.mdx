...
**Base URL:** `https://api.preprod.smartbills.io`
...
|---------|-----------|----------------|
| **Base URL** | `api.smartbills.io` | `api.preprod.smartbills.io` |
...
// Pre-Production
const PREPROD_URL = 'https://api.preprod.smartbills.io';
...
# Pre-Production
PREPROD_URL = 'https://api.preprod.smartbills.io'

# Use environment variable
BASE_URL = PROD_URL if os.getenv('ENV') == 'production' else PREPROD_URL
...
// Pre-Production
const string PREPROD_URL = "https://api.preprod.smartbills.io";
...
<AccordionGroup>
  <Accordion title="Use Environment Variables" icon="gear">
    ...
    ```bash
    # .env.development
    SMARTBILLS_API_URL=https://api.preprod.smartbills.io
    SMARTBILLS_API_KEY=your_preprod_key
