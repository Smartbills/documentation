...
<Steps>
  ...
  <Step title="Expense Creation">
    A new expense is created with the extracted data pre-filled. The expense appears in the user's Personal Wallet (for individual forwarding) or in the Company Expenses Inbox (for shared forwarding addresses).
  </Step>
...
- **How to find your address**: Go to your Personal Wallet and look for the forwarding address in the settings or header area
...
- **Company forwarding**: Organizations can also configure a shared forwarding address that routes to the Company Expenses Inbox
...
- See the [Outlook Add-in Guide](/guides/outlook/overview) for installation and setup
...
| **Admin** | Configures shared forwarding addresses, sets up email inbox integrations. Requires `SETTINGS_GENERAL_MANAGE` permission |
