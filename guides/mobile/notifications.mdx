...
<Frame>
  <img src="/images/guides/mobile/notifications/notification-example.png" alt="Push notification showing an expense approval" />
</Frame>
...
| **Reminder to Submit** | A periodic reminder that you have unsubmitted expenses in your wallet | Off |
...
<Steps>
  <Step title="Open Notification Settings">
    ...
    <Frame>
      <img src="/images/guides/mobile/notifications/notification-settings.png" alt="Notification settings screen with toggles for each notification type" />
    </Frame>
  </Step>
  ...
  <Step title="Verify Device Permissions">
    ...
    <Frame>
      <img src="/images/guides/mobile/notifications/device-permissions.png" alt="Device notification permissions for Smartbills" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Set Your Schedule">
    ...
    <Frame>
      <img src="/images/guides/mobile/notifications/dnd-schedule.png" alt="Do Not Disturb schedule with start and end time pickers" />
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Offline Mode" icon="wifi-slash" href="/guides/mobile/offline-mode">
    Learn how notifications work in offline mode
  </Card>
