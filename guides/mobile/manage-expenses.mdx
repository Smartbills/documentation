...
<Frame>
  <img src="/images/guides/mobile/manage-expenses/expenses-list.png" alt="Expenses tab showing a list of expenses with status indicators" />
</Frame>
...
<Steps>
  <Step title="Open Filters">
    ...
    <Frame>
      <img src="/images/guides/mobile/manage-expenses/filter-panel.png" alt="Filter panel with date range, category, and status options" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/guides/mobile/manage-expenses/expense-detail.png" alt="Expense detail view showing receipt image and editable fields" />
</Frame>
...
<Steps>
  ...
  <Step title="Tap Edit">
    ...
    <Frame>
      <img src="/images/guides/mobile/manage-expenses/edit-expense.png" alt="Expense in edit mode with editable fields highlighted" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Tap Add Photo">
    ...
    <Frame>
      <img src="/images/guides/mobile/manage-expenses/add-photo.png" alt="Attachments section with Add Photo button" />
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Offline Mode" icon="wifi-slash" href="/guides/mobile/offline-mode">
    Manage expenses without internet
  </Card>
</CardGroup>
