...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/hero.png" alt="Scanning a receipt with the Smartbills mobile app" />
</Frame>
...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/open-camera.png" alt="Opening the receipt scanner from the home tab" />
</Frame>
...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/position-receipt.png" alt="Receipt positioned within the camera viewfinder" />
</Frame>
...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/capture-receipt.png" alt="Receipt captured with auto-detect border visible" />
</Frame>
...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/review-data.png" alt="Review screen showing extracted receipt data" />
</Frame>
...
<Frame>
  <img src="/images/guides/mobile/scan-receipt/assign-category.png" alt="Category selection dropdown" />
</Frame>
...
1. Tap **Save** to save the expense to your personal wallet
2. The expense appears in your Expenses tab with the receipt image attached

<Frame>
  <img src="/images/guides/mobile/scan-receipt/save-expense.png" alt="Expense saved successfully with receipt attached" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Offline Mode" icon="wifi-slash" href="/guides/mobile/offline-mode">
    Scan receipts without an internet connection
  </Card>
</CardGroup>
