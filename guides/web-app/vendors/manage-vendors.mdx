...
<Steps>
  <Step title="Open the Vendor">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/select-vendor.png" alt="Clicking a vendor row to open the detail panel" />
    </Frame>
  </Step>
  ...
  <Step title="Modify Fields">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/edit-fields.png" alt="Editing vendor fields in the detail panel" />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Select the Duplicate Vendor">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/merge-button.png" alt="Merge button on the vendor detail panel" />
    </Frame>
  </Step>
  ...
  <Step title="Choose the Target Vendor">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/merge-select.png" alt="Selecting the target vendor for merging" />
    </Frame>
  </Step>
  ...
  <Step title="Confirm the Merge">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/merge-confirm.png" alt="Merge confirmation dialog showing expense count" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Upload the CSV">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/import-csv.png" alt="CSV import dialog with file upload area" />
    </Frame>
  </Step>
  ...
  <Step title="Review and Confirm">
    ...
    <Frame>
      <img src="/images/guides/web-app/vendors/import-preview.png" alt="Import preview showing vendor data to be created" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/guides/web-app/vendors/expense-history.png" alt="Vendor expense history showing a chronological list of expenses" />
</Frame>
