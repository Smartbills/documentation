...
<Frame>
  <img src="/images/guides/web-app/reports/recall-report.png" alt="Submitted report detail page with Recall button highlighted" />
</Frame>
...
<Steps>
  ...
  <Step title="Click Recall">
    ...
    <Frame>
      <img src="/images/guides/web-app/reports/recall-button.png" alt="Recall button on a submitted report" />
    </Frame>
  </Step>
