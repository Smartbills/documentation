...
<Frame>
  <img src="/images/guides/web-app/reports/create-report.png" alt="Create Expense Report dialog with title, description, and date range fields" />
</Frame>
...
<Steps>
  <Step title="Navigate to My Expense Reports">
    ...
    <Frame>
      <img src="/images/guides/web-app/reports/navigate-reports.png" alt="Sidebar with My Expense Reports highlighted" />
    </Frame>
  </Step>
  ...
  <Step title="Add Description and Business Purpose">
    ...
    <Frame>
      <img src="/images/guides/web-app/reports/report-details.png" alt="Report title and description fields filled in with example data" />
    </Frame>
  </Step>
...
After creating your report, the next step is to add expenses from your wallet.

<CardGroup cols={2}>
  <Card title="Add Expenses to a Report" icon="plus" href="/guides/web-app/reports/add-expenses">
    Select expenses from your wallet to include in the report
  </Card>
