...
<Frame>
  <img src="/images/guides/web-app/vault/manage-hero.png" alt="Managing documents in the Smartbills Vault" />
</Frame>
...
<Steps>
  <Step title="Navigate to the Vault">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/navigate-to-vault.png" alt="Clicking Vault in the sidebar" />
    </Frame>
  </Step>
  ...
  <Step title="Browse by Category or Date">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/browse-documents.png" alt="Browsing documents by category and date" />
    </Frame>
  </Step>
  ...
  <Step title="Click to Preview or Download">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/preview-download.png" alt="Document preview with download button and metadata" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Click Upload">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/upload-button.png" alt="Upload button in the Vault" />
    </Frame>
  </Step>
  ...
  <Step title="Select Files">
    ...
    **Supported formats:**
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/select-files.png" alt="Drag and drop or browse to select files for upload" />
    </Frame>
  </Step>
  ...
  <Step title="Add Tags and Description">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/add-tags-description.png" alt="Adding tags and description to uploaded documents" />
    </Frame>
  </Step>
  ...
  <Step title="Save">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/upload-complete.png" alt="Upload complete with documents added to the Vault" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/guides/web-app/vault/search-bar.png" alt="Using the search bar to find documents" />
</Frame>
...
<Steps>
  <Step title="Select Documents">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/select-for-export.png" alt="Selecting multiple documents for bulk export" />
    </Frame>
  </Step>
  ...
  <Step title="Click Download">
    ...
    <Frame>
      <img src="/images/guides/web-app/vault/download-zip.png" alt="Downloading selected documents as a ZIP archive" />
    </Frame>
  </Step>
</Steps>
