...
<Frame>
  <img src="/images/guides/web-app/settings/departments-overview.png" alt="Departments settings page" />
</Frame>
...
<Steps>
  <Step title="Open Department Settings">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/departments-list.png" alt="List of existing departments" />
    </Frame>
  </Step>
  ...
  <Step title="Click Add Department">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/departments-add.png" alt="Add Department button" />
    </Frame>
  </Step>
  ...
  <Step title="Enter Department Details">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/departments-form.png" alt="Department creation form with name, cost center, and approver fields" />
    </Frame>
