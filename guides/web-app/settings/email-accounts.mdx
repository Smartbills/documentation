...
<Frame>
  <img src="/images/guides/web-app/settings/email-accounts-overview.png" alt="Email accounts settings page" />
</Frame>
...
<Steps>
  <Step title="Open Email Account Settings">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/email-accounts-list.png" alt="Email accounts list showing connected accounts" />
    </Frame>
  </Step>
  ...
  <Step title="Click Connect Account">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/email-accounts-connect.png" alt="Connect Account button with provider selection" />
    </Frame>
  </Step>
  ...
  <Step title="Authorize Access">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/email-accounts-oauth.png" alt="OAuth authorization screen for email provider" />
    </Frame>
  ...
  <Step title="Confirm Connection">
    ...
    <Frame>
      <img src="/images/guides/web-app/settings/email-accounts-connected.png" alt="Successfully connected email account showing Active status" />
    </Frame>
  </Step>
</Steps>
