...
<Frame>
  <img src="/images/guides/web-app/approvals/approve-hero.png" alt="Approving an expense report in Smartbills" />
</Frame>
...
<Steps>
  <Step title="Navigate to Approvals">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/sidebar-badge.png" alt="Sidebar showing Approvals with pending badge count" />
    </Frame>
  </Step>
  ...
  <Step title="Open a Pending Report">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/select-pending-report.png" alt="Clicking on a pending expense report in the approval queue" />
    </Frame>
  </Step>
  ...
  <Step title="Review the Report Summary">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/report-summary.png" alt="Report summary showing total amount, expense count, submitter, and date range" />
    </Frame>
  </Step>
  ...
  <Step title="Review Individual Expenses">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/expense-detail.png" alt="Reviewing an individual expense with receipt image and details" />
    </Frame>
  </Step>
  ...
  <Step title="Click Approve">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/approve-button.png" alt="Approve button highlighted in the report detail view" />
    </Frame>
  </Step>
  ...
  <Step title="Add an Approval Note (Optional)">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/approval-note.png" alt="Approval confirmation dialog with optional note field" />
    </Frame>
  </Step>
  ...
  <Step title="Confirm the Approval">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/confirm-approval.png" alt="Clicking Confirm Approval to finalize" />
    </Frame>
  </Step>
  ...
  <Step title="Submitter Is Notified">
    ...
    <Frame>
      <img src="/images/guides/web-app/approvals/approval-notification.png" alt="Notification sent to the submitter confirming approval" />
    </Frame>
  </Step>
</Steps>
