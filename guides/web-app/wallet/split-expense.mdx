...
<Steps>
  <Step title="Open the Expense">
    Navigate to **Wallet** in the sidebar and click on the expense you want to split.

    <Frame>
      <img src="/images/guides/web-app/wallet/split-expense/open-expense.png" alt="Expense detail view for an expense to be split" />
    </Frame>
  </Step>
  ...
  <Step title="Click the Split Button">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/split-expense/split-button.png" alt="Split button in the expense detail toolbar" />
    </Frame>
  </Step>
  ...
  <Step title="Add Split Lines">
    ...
    **Example**: A $100.00 dinner receipt split into two lines:
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/split-expense/add-lines.png" alt="Split editor with two lines showing amounts, categories, and departments" />
    </Frame>
  </Step>
  ...
  <Step title="Verify the Total">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/split-expense/verify-total.png" alt="Split total matching the original expense amount with a green checkmark" />
    </Frame>
  ...
  <Step title="Save the Split">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/split-expense/save-split.png" alt="Saved split expense showing the breakdown in the detail view" />
    </Frame>
  </Step>
</Steps>
