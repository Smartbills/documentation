...
Receipt forwarding lets you send email receipts directly to Smartbills, where they are automatically processed and added to your Wallet. This is useful for digital receipts from online purchases, airline bookings, subscription services, and any vendor that sends receipts by email.
...
4. Creates a new expense in your Wallet with a **Draft** status
...
<Steps>
  <Step title="Find Your Forwarding Address">
    ...
    **Option B: From Settings**
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/receipt-forwarding/forwarding-address.png" alt="Receipt forwarding page showing the unique email address with a copy button" />
    </Frame>
  </Step>
  ...
  <Step title="Copy the Address">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/receipt-forwarding/copy-address.png" alt="Copying the forwarding email address to clipboard" />
    </Frame>
  </Step>
  ...
  <Step title="Forward a Receipt">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/receipt-forwarding/forward-email.png" alt="Forwarding an email receipt to the Smartbills forwarding address" />
    </Frame>
  </Step>

  <Step title="Check Your Wallet">
    Within a few seconds, the receipt appears as a new expense in your Wallet. Open it to review the extracted data and make any corrections.

    <Frame>
      <img src="/images/guides/web-app/wallet/receipt-forwarding/new-expense.png" alt="New expense created from a forwarded receipt appearing in the Wallet" />
    </Frame>
  </Step>
</Steps>

<Check>
  Your forwarded receipt has been processed and added to your Wallet as a new expense.
</Check>
...
- **Check your spam folder** -- If a forwarded receipt does not appear in your Wallet, make sure the confirmation email from Smartbills is not in your spam folder
...
This way, receipts arrive in your Wallet without any manual forwarding.

## Outlook Add-In

If your organization uses Microsoft Outlook, the Smartbills Outlook add-in provides a one-click button to forward receipts without leaving your inbox. See the [Outlook Add-in Guide](/guides/outlook/overview) for setup instructions.
...
<CardGroup cols={2}>
  ...
  <Card title="Outlook Add-in" icon="envelope-open-text" href="/guides/outlook/overview">
