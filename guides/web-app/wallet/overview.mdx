...
description: "Manage your personal business expenses in the wallet"
---

<Frame>
  <img src="/images/guides/web-app/wallet/overview/hero.png" alt="Personal wallet page showing a list of expenses" />
</Frame>

## Introduction

The **Wallet** is your personal space for managing business expenses. Located in the sidebar under your personal section, it is the first place you go to upload receipts, review extracted data, and prepare expenses for reporting.

Every expense you create -- whether uploaded manually, scanned from a photo, or received via email forwarding -- appears here.

## Wallet Page Layout

When you open the Wallet, you will see:
...
<Frame>
  <img src="/images/guides/web-app/wallet/overview/wallet-layout.png" alt="Wallet page layout with filters, expense list, and Add Expense button" />
</Frame>

## Expense Statuses

Each expense in your wallet has a status that indicates where it is in the workflow:
...
<Frame>
  <img src="/images/guides/web-app/wallet/overview/expense-detail.png" alt="Expense detail view showing receipt image and editable fields" />
</Frame>
