...
<Steps>
  <Step title="Open the Expense">
    Navigate to **Wallet** in the sidebar and click on the expense you want to edit. The expense detail view opens, showing the receipt image on one side and the editable fields on the other.

    <Frame>
      <img src="/images/guides/web-app/wallet/edit-expense/open-expense.png" alt="Expense detail view with receipt image and form fields" />
    </Frame>
  </Step>
  ...
  <Step title="Modify the Fields">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/edit-expense/edit-fields.png" alt="Editing the merchant name and amount fields on an expense" />
    </Frame>
  </Step>
  ...
  <Step title="Save Your Changes">
    ...
    <Frame>
      <img src="/images/guides/web-app/wallet/edit-expense/save-changes.png" alt="Save button highlighted after editing expense fields" />
    </Frame>
  </Step>
</Steps>
...
- **Expenses in a draft report** can still be edited from the Wallet
