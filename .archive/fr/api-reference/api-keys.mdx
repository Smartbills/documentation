...
<AccordionGroup>
  ...
  <Accordion title="Portees dépenses" icon="receipt">
    **expenses.read** - Lister les dépenses, obtenir les détails, télécharger les pieces jointes, exporter les données

    **expenses.write** - Téléverser des dépenses, mettre à jour les informations, ajouter ou supprimer des pieces jointes, catégoriser

    **receipts.read** / **receipts.write** - Accéder aux reçus sous-jacents et les modifier
  </Accordion>

  <Accordion title="Portees rapports de dépenses" icon="file-invoice">
  ...
  <Accordion title="Portees comptes fournisseurs" icon="file-invoice-dollar">
  ...
  <Accordion title="Portees identité" icon="user">
  ...
  <Accordion title="Portees plateforme" icon="gear">
