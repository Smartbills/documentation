...
<CardGroup cols={2}>
  <Card title="Expenses" icon="receipt" href="/api-reference/expenses/list-expenses">
    Create, read, update, and delete expenses. Upload attachments and export expense data.
  </Card>
  <Card title="Expense Reports" icon="file-invoice" href="/api-reference/expense-reports/list-reports">
    Create and manage expense reports. Submit, approve, reject, and track report workflows.
  </Card>
  <Card title="Businesses" icon="building" href="/api-reference/businesses/list-businesses">
    Manage businesses and their settings.
  </Card>
  <Card title="Vendors" icon="store" href="/api-reference/vendors/list-vendors">
    Manage vendors and supplier information.
  </Card>
  <Card title="Categories" icon="tags" href="/api-reference/categories/list-categories">
    Manage expense categories for organizing expenses.
  </Card>
  <Card title="Departments" icon="sitemap" href="/api-reference/departments/list-departments">
    Manage departments and organizational structure.
  </Card>
  <Card title="Employees" icon="users" href="/api-reference/employees/list-employees">
...
- [Python SDK](/sdks/python) (`smartbills`)
