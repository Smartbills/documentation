...
<Steps>
  <Step title="Un événement se produit">
    Une action se produit dans Smartbills (ex. : dépense créée, rapport approuve)
  </Step>
...
<Warning>
  **Retournez 200 OK** : Retournez toujours un code de statut 200 lorsque vous recevez le webhook avec succès, meme si le traitement échoué. Gérez les erreurs de traitement en interne pour eviter les réessais inutiles.
</Warning>
...
Utilisez des outils comme [ngrok]( URLPH0 ) pour tester les webhooks pendant le développement local :
