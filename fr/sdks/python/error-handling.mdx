...
try:
    ...
    print("Le rapport est deja soumis ou dans un etat incompatible")
```
...
Le SDK à des tentatives intégrées pour les erreurs transitoires (429, 5xx, erreurs réseau). Pour un contrôle supplémentaire, implémentez votre propre logique de tentatives :
...
| **Timeouts lecture/écriture** | Retente avec back-off exponentiel |
