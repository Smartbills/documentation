...
<Steps>
  <Step title="Détection">
    Lorsqu'une nouvelle dépense est créée à partir d'un reçu, Smartbills utilise l'OCR pour extraire le nom du fournisseur. Le système vérifie le nom extrait par rapport à votre répertoire de fournisseurs existant pour trouver une correspondance.
  </Step>
...
Lorsqu'une nouvelle dépense arrive, Smartbills utilise la correspondance de fournisseurs pour la lier au bon enregistrement. Le processus de correspondance gère les variations courantes :
