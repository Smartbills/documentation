...
<Steps>
  ...
  <Step title="En révision">
    L'approbateur examine chaque dépense du rapport, vérifiant les reçus, les montants, les catégories et la justification d'affaires. L'approbateur peut approuver l'ensemble du rapport, le rejeter ou demander des modifications sur des dépenses spécifiques.
  </Step>
...
| **Rejeté** | Le rapport a été renvoyé à l'employé avec des commentaires. |
| **Remboursé** | L'employé a été payé pour les dépenses approuvées. |
...
| **Gestionnaire / Approbateur** | Révise les rapports soumis, approuvé, rejette ou demande des modifications |
