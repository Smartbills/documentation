...
<Frame>
  <img src="/images/guides/web-app/inbox/review-expenses.png" alt="Vue détaillée d'une dépense affichant l'image du reçu et les champs de données extraits" />
</Frame>
...
<Steps>
  ...
  <Step title="Filtrer par statut">
    ...
    <Frame>
      <img src="/images/guides/web-app/inbox/status-filter.png" alt="Menu déroulant du filtre de statut affichant les options En attente, Information manquante et Signalée" />
    </Frame>
  </Step>
  <Step title="Ouvrir la vue détaillée">
    Cliquez sur n'importe quelle ligne de dépense pour ouvrir le panneau de detail. La vue détaillée affiche l'image du reçu d'un côté et les données de la dépense de l'autre, vous permettant de les comparer côté à cote.
  </Step>
  <Step title="Vérifier les données du reçu">
    ...
    <Frame>
      <img src="/images/guides/web-app/inbox/verify-receipt.png" alt="Vue côté à côté de l'image du reçu et des champs de données extraits" />
    </Frame>
  </Step>
  ...
  <Step title="Agir">
    ...
    - **Approuver** -- Marquer la dépense comme vérifiée et correctement categorisee. Elle passe au statut Approuvee.
    ...
    <Frame>
      <img src="/images/guides/web-app/inbox/action-buttons.png" alt="Boutons Approuver, Signaler et Retourner pour revision en bas de la vue détaillée" />
    </Frame>
  </Step>
</Steps>
