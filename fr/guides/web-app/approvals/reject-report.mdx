...
<Steps>
  ...
  <Step title="Saisir la Raison du Rejet">
    Une boîte de dialogue apparaît vous demandant de saisir une raison pour le rejet. Ce champ est **obligatoire**. Fournissez une explication claire et actionnable pour que le soumetteur sache ce qui doit être corrigé.
  ...
  <Step title="Le Soumetteur est Notifié">
...
|----------|-------------------|
| Problèmes mineurs pouvant être corrigés sur place | [Demander des Modifications](/fr/guides/web-app/approvals/request-changes) |
