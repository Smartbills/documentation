...
<Steps>
  ...
  <Step title="Modifier les Champs">
    ...
    | **Notes** | Contexte ou description supplémentaire |
...
Si vous avez téléchargé le mauvais fichier ou devez joindre une image plus claire, vous pouvez remplacer le reçu :
...
- **Dépenses dans un rapport soumis** sont verrouillées. Vous devez rappeler le rapport avant de faire des modifications
