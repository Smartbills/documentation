...
description: "Gérez vos dépenses professionnelles personnelles dans le portefeuille"
---

<Frame>
  <img src="/images/guides/web-app/wallet/overview/hero.png" alt="Page du portefeuille personnel affichant une liste de dépenses" />
</Frame>

## Introduction

Le **Portefeuille** est votre espace personnel pour gérer vos dépenses professionnelles. Situé dans la barre latérale sous votre section personnelle, c'est le premier endroit où vous allez pour télécharger des reçus, examiner les données extraites et préparer les dépenses pour vos rapports.
...
## Disposition de la Page du Portefeuille

Lorsque vous ouvrez le Portefeuille, vous verrez :
...
<Frame>
  <img src="/images/guides/web-app/wallet/overview/wallet-layout.png" alt="Disposition de la page du portefeuille avec filtres, liste de dépenses et bouton Ajouter une Dépense" />
</Frame>

## Statuts des Dépenses

Chaque dépense dans votre portefeuille à un statut qui indique ou elle se trouve dans le flux de travail :
...
<Frame>
  <img src="/images/guides/web-app/wallet/overview/expense-detail.png" alt="Vue détail de la dépense montrant l'image du reçu et les champs modifiables" />
</Frame>
